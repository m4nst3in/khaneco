...
🙂 Stable:
```js
javascript:fetch("https://raw.githubusercontent.com/Niximkk/Khaneco/refs/heads/main/Khaneco.js").then(t=>t.text()).then(eval);
```
🔧 Dev (beta):
```js
javascript:fetch("https://raw.githubusercontent.com/Niximkk/Khaneco/refs/heads/main/Khaneco.js").then(t=>t.text()).then(eval);
...
🪶 Minimal (beta):
```js
javascript:fetch("https://raw.githubusercontent.com/Niximkk/Khaneco/refs/heads/main/khanecoMinimal.js").then(t=>t.text()).then(eval);
```
