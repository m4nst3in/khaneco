const phrases = [ 
    "🔥 Get good, get [Khaneco](https://github.com/Niximkk/khaneco/)!",
    "🤍 Made by [@im.nix](https://e-z.bio/sounix).",
    "☄️ By [Niximkk/khaneco](https://github.com/Niximkk/khaneco/).",
    "🌟 Star the project on [GitHub](https://github.com/Niximkk/khaneco/)!",
    "🦢 Nix fez a boa ;)",
];
